  ...
  return async function (moduleArg = {}) {
    ...
    var MEMFS = {
      ...
      getFileDataAsTypedArray(node) {
        assert(
          FS.isFile(node.mode),
          "getFileDataAsTypedArray called on non-file",
        );
    ...
    function assignWasmExports(wasmExports) {
      ...
      assert(
        typeof wasmExports["setThrew"] != "undefined",
